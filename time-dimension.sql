...
SELECT * FROM [aqsdb].[DimDate]


/*Add Fiscal date columns to DimDate*/
ALTER TABLE [aqsdb].[DimDate] ADD
...
DECLARE
	@dtFiscalYearStart SMALLDATETIME = 'January 01, 1990',
	@FiscalYear INT = 1990,
	@LastYear INT = 2025,
	@FirstLeapYearInPeriod INT = 1992
...
FROM @tb a
	INNER JOIN [aqsdb].[DimDate] b ON a.PeriodDate = b.[Date]
